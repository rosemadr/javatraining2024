...
//    They also make it possible to have a null default e.g. for boolean
//    Some places we cannot use primative data types: e.g. in Arrays, which only allow reference types as elements
//    They are immutable
